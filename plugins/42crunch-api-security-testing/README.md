...
Generates a complete `openapi.json` from an API codebase, a Postman or Insomnia collection, or both. Copilot asks which sources are available and uses whichever you provide:
